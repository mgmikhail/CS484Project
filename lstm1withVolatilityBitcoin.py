...
scaler = MinMaxScaler()
df[['Price', 'EMA10', 'Volatility']] = scaler.fit_transform(df[['Price', 'EMA10', 'Volatility']])



# Extract closing prices, time deltas, EMA, and volatility
closingPrices = df[['Price', 'TimeDelta', 'EMA10', 'Volatility']].values
...
X_train = np.reshape(X_train, (X_train.shape[0], X_train.shape[1], 4))  # Now includes 'Price', 'TimeDelta', 'EMA10', and 'Volatility'
